...
def make_list():
	...
	d = xbmcgui.Dialog()
	d.ok('AFLTV Error', 'AFLTV does not support livestreams yet.')
...
"""def make_list():
	...
	try:
		...
		for channel in config.LIVE: #nope we actually have to gather these stuff !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
